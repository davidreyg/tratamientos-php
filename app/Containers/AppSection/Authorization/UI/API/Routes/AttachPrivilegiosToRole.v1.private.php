...
use App\Containers\AppSection\Authorization\UI\API\Controllers\AttachPrivilegiosToRoleController;
use Illuminate\Support\Facades\Route;

Route::post('roles/{id}/privilegios', AttachPrivilegiosToRoleController::class)
    ->middleware(['auth:api']);
